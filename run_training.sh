...
for p in 10000 50000 100000 500000 1000000 5000000 ; do
    base="output/jl_small_hgq_${p}_ebops_10_data"

    python tagger/train/train.py -p 10 -e ${p} -y tagger/model/configs/JEDIlinear_HGQ2.yaml -o $base > ${base%_data}_training_out.txt
    python tagger/train/train.py -p 10 -e ${p} -y tagger/model/configs/JEDIlinear_HGQ2.yaml -o $base --plot-basic > ${base%_data}_testing_out.txt
    rm -r output/jl_hgq_${p}_ebops_10_data/testing_data
done
