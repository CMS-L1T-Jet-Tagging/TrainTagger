...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.JetTaggerNN.autotvin_model_input.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.JetTaggerNN.autotvout_layer22_out_0.dat"
         "rtl.JetTaggerNN.autotvout_layer22_out_1.dat"
         "rtl.JetTaggerNN.autotvout_layer22_out_2.dat"
         "rtl.JetTaggerNN.autotvout_layer22_out_3.dat"
         "rtl.JetTaggerNN.autotvout_layer22_out_4.dat"
         "rtl.JetTaggerNN.autotvout_layer22_out_5.dat"
         "rtl.JetTaggerNN.autotvout_layer22_out_6.dat"
         "rtl.JetTaggerNN.autotvout_layer22_out_7.dat"
         "rtl.JetTaggerNN.autotvout_layer23_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
