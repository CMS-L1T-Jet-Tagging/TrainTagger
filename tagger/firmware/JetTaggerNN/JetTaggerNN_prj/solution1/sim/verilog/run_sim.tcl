...
if {[file isfile JetTaggerNN.autotvin.dat]} {
	file delete -force JetTaggerNN.autotvin.dat
}

if {[file isfile JetTaggerNN.autotvout.dat]} {
	file delete -force JetTaggerNN.autotvout.dat
}
