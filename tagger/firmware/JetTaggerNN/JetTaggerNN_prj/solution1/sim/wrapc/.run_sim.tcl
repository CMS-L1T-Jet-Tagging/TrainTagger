...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /software/CAD/Xilinx/2022.2/Vitis_HLS/2022.2/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /software/CAD/Xilinx/2022.2/Vitis_HLS/2022.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /software/CAD/Xilinx/2022.2/Vitis_HLS/2022.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /software/CAD/Xilinx/2022.2/Vitis_HLS/2022.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "JetTaggerNN.autotvin.dat"
	set constFileTvOut       "JetTaggerNN.autotvout.dat"
	set constFileHdlTvIn     "JetTaggerNN.autohdltvin.dat"
	set constFileHdlTvOut    "JetTaggerNN.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
