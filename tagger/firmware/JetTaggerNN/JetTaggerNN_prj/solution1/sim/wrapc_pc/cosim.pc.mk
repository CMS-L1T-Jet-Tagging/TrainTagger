...
AUTOPILOT_ROOT := /software/CAD/Xilinx/2022.2/Vitis_HLS/2022.2
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /software/CAD/Xilinx/2022.2/Vitis_HLS/2022.2/tps/lnx64/gcc-8.3.0/bin
endif
...
$(ObjDir)/JetTaggerNN_test.cpp_pre.cpp.tb.o : JetTaggerNN_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling JetTaggerNN_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/JetTaggerNN.cpp_pre.cpp.tb.o : JetTaggerNN.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling JetTaggerNN.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
