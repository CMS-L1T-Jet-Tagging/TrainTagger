...
@JetModelFactory.register('DeepSetModelPtOnly')
class DeepSetModelPtOnly(QKerasModel):
    ...
    def build_model(self, inputs_shape: tuple, outputs_shape: tuple):
        ...
        self.jet_model = tf.keras.Model(inputs=inputs, outputs=pt_regress)
    ...
    def fit(
        ...
        self.history = self.jet_model.fit(
            ...
            sample_weight={
                self.loss_name + self.output_pt_name: sample_weight,
            },
