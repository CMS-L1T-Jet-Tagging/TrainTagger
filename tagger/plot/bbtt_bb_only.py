...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--signal', default='/eos/cms/store/cmst3/group/l1tr/sewuchte/l1teg/fp_jettuples_220926_170X_v0.1/GluGluHHTo2B2Tau_PU200.root' , help = 'Signal sample for HH->bbtt')
